...
docker build -f Dockerfile-ubuntu16.04-qt5.6-py3.6 -t fredrikaverpil/pyside2-ubuntu16.04-qt5.6-py3.6 .
...
docker run --rm -v $(pwd):/pyside-setup/dist fredrikaverpil/pyside2-ubuntu16.04-qt5.6-py3.6
```
